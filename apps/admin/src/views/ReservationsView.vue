...
.view-switch{display:flex;gap:3px;padding:3px;border-radius:var(--radius-9);background:var(--color-tab-bg)}
.view-switch button{min-height:32px;padding:0 13px;border:0;border-radius:var(--radius-7);background:transparent;color:var(--color-text-secondary);font-size:var(--font-size-13);font-weight:700}
