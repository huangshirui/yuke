...
<style scoped>
.detail-section-grid{display:grid;grid-template-columns:minmax(0,.9fr) minmax(0,1.1fr);gap:12px;margin-bottom:12px}.detail-section{padding:0;margin-bottom:12px}.compact-panel-heading{min-height:46px;padding:0 16px;border-bottom:var(--border-width) solid var(--color-border);display:flex;align-items:center;justify-content:space-between;gap:12px}.compact-panel-heading h2{margin:0;font-size:var(--font-size-15)}.compact-panel-heading small{color:var(--color-text-secondary);font-size:var(--font-size-11)}.detail-list{margin:0;padding:8px 16px}.detail-list>div{min-height:38px;display:grid;grid-template-columns:96px minmax(0,1fr);align-items:center;border-bottom:var(--border-width) solid var(--color-border-subtle)}.detail-list>div:last-child{border-bottom:0}.detail-list dt{font-size:var(--font-size-12);color:var(--color-text-secondary)}.detail-list dd{margin:0;font-size:var(--font-size-13);font-weight:650;overflow-wrap:anywhere}.compact-editor{padding:14px 16px;display:grid;gap:10px}.compact-editor textarea{width:100%;resize:vertical}.compact-editor .button{justify-self:end}.participant-detail-list{display:grid}.participant-detail-row{display:grid;grid-template-columns:minmax(150px,.7fr) minmax(180px,.8fr) minmax(260px,1.4fr);gap:14px;padding:14px 16px;border-bottom:var(--border-width) solid var(--color-border)}.participant-detail-row:last-child{border-bottom:0}.participant-identity{display:flex;align-items:center;gap:8px;flex-wrap:wrap}.participant-identity>span:not(.status-pill){font-size:var(--font-size-12);color:var(--color-text-secondary)}.participant-user-note>span{font-size:var(--font-size-11);color:var(--color-text-secondary)}.participant-user-note p{margin:5px 0 0;font-size:var(--font-size-13);line-height:1.45}.participant-admin-note .button{justify-self:start;margin-top:4px}@media(max-width:820px){.detail-section-grid{grid-template-columns:1fr}.participant-detail-row{grid-template-columns:1fr}.compact-editor .button{width:100%}}
</style>
