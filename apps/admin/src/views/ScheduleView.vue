...
.week-nav{display:flex;align-items:center;justify-content:center;gap: var(--space-6)}.week-nav strong{min-width:88px;text-align:center;font-size:var(--font-size-13)}.icon-nav{min-width:36px;padding-inline: var(--space-10);font-size:var(--font-size-18)}
