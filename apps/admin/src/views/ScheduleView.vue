...
.schedule-toolbar{min-height:58px;display:grid;grid-template-columns:minmax(210px,280px) 1fr auto;align-items:center;gap:14px;margin-bottom:12px;padding:8px 10px;border:var(--border-width) solid var(--color-border);border-radius:var(--radius-12);background:var(--color-white)}
.compact-field{display:flex;align-items:center;gap:9px;min-width:0}.compact-field>span{font-size:var(--font-size-12);font-weight:700;color:var(--color-text-secondary);white-space:nowrap}.compact-field select{min-width:0;width:100%;height:var(--control-height-md)}
.week-nav{display:flex;align-items:center;justify-content:center;gap:6px}.week-nav strong{min-width:88px;text-align:center;font-size:var(--font-size-13)}.icon-nav{min-width:36px;padding-inline:10px;font-size:var(--font-size-18)}
.schedule-panel{overflow:auto;padding:0}.week-head,.schedule-body{display:grid;grid-template-columns:58px repeat(7,minmax(116px,1fr));min-width:890px}.time-gutter,.day-head{height:50px;border-bottom:var(--border-width) solid var(--color-border)}.day-head{display:grid;align-content:center;gap:2px;padding:0 10px;border-left:var(--border-width) solid var(--color-border)}.day-head strong{font-size:var(--font-size-13)}.day-head span{color:var(--color-text-secondary);font-size:var(--font-size-11)}.schedule-body{align-items:start}.time-column{display:grid}.time-label{height:34px;padding:6px 7px;color:var(--color-text-secondary);font-size:var(--font-size-10);border-bottom:var(--border-width) solid var(--color-border)}.day-column{position:relative;border-left:var(--border-width) solid var(--color-border);min-height:850px}.time-cell{display:block;width:100%;height:34px;border:0;border-bottom:var(--border-width) solid var(--color-border);background:transparent;padding:0;cursor:crosshair}.time-cell:hover,.time-cell--selected{background:var(--color-primary-soft)}.day-slots{position:absolute;inset:0;pointer-events:none}.slot-card{position:absolute;left:4px;right:4px;pointer-events:auto;border:var(--border-width) solid var(--color-slot-border);border-left:var(--border-width-strong) solid var(--color-primary);border-radius:var(--radius-7);background:var(--color-white);padding:6px 7px;text-align:left;display:grid;align-content:start;gap:2px;box-shadow:var(--shadow-slot);overflow:hidden}.slot-card strong{font-size:var(--font-size-12);line-height:1.15;white-space:nowrap}.slot-card span{font-size:var(--font-size-10);line-height:1.25;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.slot-card small{font-size:var(--font-size-9);line-height:1.2}.slot-booking-line{color:var(--color-text-primary)!important;font-weight:650}.slot-operational-state{color:var(--color-text-secondary)}.slot-availability{color:var(--color-primary)!important}.slot-card--frozen{border-color:var(--color-slot-frozen-border);border-left-color:var(--color-slot-frozen-accent);background:var(--color-slot-frozen-bg)}
.mobile-agenda{display:none}
.modal-backdrop{position:fixed;inset:0;background:var(--color-overlay-soft);display:grid;place-items:center;padding:24px;z-index:20}.modal-card{width:min(720px,100%);max-height:90vh;overflow:auto;background:var(--color-white);border-radius:var(--radius-16);padding:20px;box-shadow:var(--shadow-schedule-modal)}.schedule-form{margin-top:12px}.slot-detail-meta{display:flex;gap:8px;flex-wrap:wrap;margin:10px 0 4px}.slot-detail-meta span{padding:4px 8px;border-radius:var(--radius-pill);background:var(--color-neutral-pill);color:var(--color-text-secondary);font-size:var(--font-size-11)}.repeat-panel{margin-top:14px;padding:14px;border:var(--border-width) solid var(--color-border);border-radius:var(--radius-10);display:grid;gap:12px}.field-label{font-size:var(--font-size-12);font-weight:600}.weekday-picker{display:flex;gap:6px;flex-wrap:wrap}.weekday-button{border:var(--border-width) solid var(--color-border);background:var(--color-white);border-radius:var(--radius-pill);padding:6px 10px;cursor:pointer;font-size:var(--font-size-12)}.weekday-button.active{background:var(--color-primary-soft);border-color:var(--color-primary);color:var(--color-primary)}.modal-actions{display:flex;justify-content:flex-end;align-items:center;gap:8px;margin-top:16px}.modal-actions-spacer{flex:1}
@media(max-width:820px){.schedule-toolbar{grid-template-columns:1fr auto;gap:8px}.schedule-toolbar>.button--primary{grid-column:2;grid-row:1}.week-nav{grid-column:1 / -1;justify-content:space-between;border-top:var(--border-width) solid var(--color-border);padding-top:8px}.desktop-schedule{display:none}.mobile-agenda{display:block;border:var(--border-width) solid var(--color-border);border-radius:var(--radius-12);background:var(--color-white);overflow:hidden}.mobile-day-nav{min-height:52px;display:grid;grid-template-columns:40px 1fr 40px;align-items:center;border-bottom:var(--border-width) solid var(--color-border);padding:4px 8px}.mobile-day-nav>div{display:flex;align-items:center;justify-content:center;gap:8px}.mobile-day-nav strong{font-size:var(--font-size-14)}.mobile-day-nav span{font-size:var(--font-size-12);color:var(--color-text-secondary)}.agenda-list{display:grid}.agenda-slot{min-height:60px;border:0;border-bottom:var(--border-width) solid var(--color-border);background:var(--color-white);padding:9px 12px;display:grid;grid-template-columns:92px minmax(0,1fr) 16px;align-items:center;gap:10px;text-align:left;color:var(--color-text-primary)}.agenda-slot:last-child{border-bottom:0}.agenda-slot--booked{background:var(--color-booked-row-bg)}.agenda-slot--frozen{background:var(--color-slot-frozen-bg)}.agenda-time{font-size:var(--font-size-12);color:var(--color-text-secondary)}.agenda-main{display:grid;gap:2px}.agenda-main strong{font-size:var(--font-size-14)}.agenda-main small{font-size:var(--font-size-12);color:var(--color-text-secondary)}.agenda-state{font-size:var(--font-size-11)!important}.modal-backdrop{align-items:end;padding:0}.modal-card{width:100%;max-width:none;max-height:92vh;border-radius:var(--radius-18) var(--radius-18) 0 0;padding:18px 16px calc(18px + env(safe-area-inset-bottom))}}
@media(max-width:560px){.schedule-toolbar{grid-template-columns:minmax(0,1fr) auto}.compact-field>span{display:none}.schedule-toolbar>.button--primary{padding-inline:12px}.week-nav .button:first-child{font-size:var(--font-size-13)}}
</style>
